...
Route::group(['middleware' => ['auth', 'verified']], function () {
    ...
    Route::post('browse/block-user', [BrowseController::class, 'blockUser'])->name('browse.block-user');
    ...
    Route::post('files/{file}/love', [FileController::class, 'toggleLove'])->name('files.love');
    Route::post('files/{file}/like', [FileController::class, 'toggleLike'])->name('files.like');
    Route::post('files/{file}/dislike', [FileController::class, 'toggleDislike'])->name('files.dislike');
    Route::post('files/{file}/laughed-at', [FileController::class, 'toggleLaughedAt'])->name('files.laughed-at');
