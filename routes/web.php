...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/api/files/{file}/source-media/{variant}', \App\Http\Controllers\ResolveSourceMediaController::class)
        ->whereIn('variant', \App\Enums\SourceMediaVariant::values())
        ->name('api.files.source-media');
