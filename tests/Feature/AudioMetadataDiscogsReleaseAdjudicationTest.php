...
test('ai adjudicates competing discogs releases before proposing release-level metadata', function () {
    ...
    $response->assertAccepted()
        ...
        ->assertJsonPath('proposal.field_options.discogs_release_id.0.value', '2588959')
        ->assertJsonPath('proposal.field_options.track_number.0.value', '4')
        ->assertJsonPath('proposal.field_options.disc_number.0.value', '2')
        ->assertJsonPath('proposal.field_options.release_label.0.value', 'Walt Disney Records')
        ->assertJsonPath('proposal.field_options.catalog_number.0.value', '50999 9472892 7')
        ->assertJsonPath('proposal.field_options.barcode.0.value', '5 099994 728927')
        ->assertJsonPath('proposal.field_options.release_date.0.value', '2010-12-08')
        ->assertJsonPath('proposal.field_options.release_country.0.value', 'Europe')
