...
test('fingerprint metadata follows up musicbrainz recording releases when acoustid omits release data', function () {
    ...
    $response->assertAccepted()
        ...
        ->assertJsonPath('proposal.field_options.barcode.0.value', '4562207978064')
        ->assertJsonPath('proposal.field_options.release_date.0.value', '2011-05-25')
        ->assertJsonPath('proposal.field_options.release_country.0.value', 'JP')
        ->assertJsonPath('proposal.field_options.musicbrainz_recording_id.0.value', 'tokitsukasadoru-recording')
        ->assertJsonPath('proposal.field_options.musicbrainz_release_id.0.value', 'tokitsukasadoru-release')
...
test('fingerprint metadata prefers a current album release over a same-title single release', function () {
    ...
    $response->assertAccepted()
        ->assertJsonPath('proposal.proposed_values', [])
        ->assertJsonPath('proposal.field_options.album.0.value', 'Amaranthe')
        ->assertJsonPath('proposal.field_options.musicbrainz_release_id.0.value', 'amaranthe-album-release')
        ->assertJsonPath('proposal.field_options.track_number.0.value', '3')
