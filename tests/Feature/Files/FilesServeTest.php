...
test('serve returns imported files from atlas storage', function () {
    Storage::fake('atlas');

    $admin = User::factory()->admin()->create();
    $filePath = 'imports/aa/bb/imported-track.mp3';
    Storage::disk('atlas')->put($filePath, 'atlas-imported-content');
