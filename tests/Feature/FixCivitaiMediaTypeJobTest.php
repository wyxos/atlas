...
it('uses thumbnail_url as fallback when referrer URL returns 404', function () {
    Storage::fake('atlas_app');
    Storage::fake('atlas');
    ...
    Http::fake([
        $referrerUrl => Http::response('Not Found', 404),
        $thumbnailUrl => Http::response($mp4Body, 200, ['Content-Type' => 'video/mp4']),
    ]);

    $file = File::factory()->create([
        'source' => 'CivitAI',
        'url' => 'https://image.civitai.com/xG1nkqKTMzGDvpLrqFT7WA/96b33e41-8a73-4faa-8ba2-02f65e80dc35/original=true/poster.webp',
        'referrer_url' => $referrerUrl,
...
it('skips file when referrer returns 404 and thumbnail_url does not have mp4 extension', function () {
    Storage::fake('atlas_app');
    Storage::fake('atlas');
    ...
    $referrerUrl = 'https://civitai.com/images/123456';
    $thumbnailUrl = 'https://image.civitai.com/xG1nkqKTMzGDvpLrqFT7WA/96b33e41-8a73-4faa-8ba2-02f65e80dc35/original=true/thumb.jpeg';
