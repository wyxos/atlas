...
<template>
    <aside
        class="flex h-full min-h-0 w-full shrink-0 flex-col overflow-hidden border-y border-r border-twilight-indigo-500 bg-prussian-blue-800 md:border-l md:border-r-0"
