...
function createProps() {
    return {
        ...
        openFileSheet: vi.fn(),
        promptDialog: { data: { promptDialogOpen: ref(false), promptDialogItemId: ref(null), promptDataLoading: ref(false), currentPromptData: ref(null) }, setOpen: vi.fn(), copy: vi.fn(), openTestPage: vi.fn(), close: vi.fn() },
        resolve: vi.fn(),
