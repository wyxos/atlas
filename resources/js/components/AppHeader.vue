...
<Button variant="ghost" size="icon" class="group h-9 w-9 cursor-pointer" @click="cycleAppearance">
    <span class="sr-only">Toggle theme</span>
    <component :is="appearanceIcon" :size="20" />
</Button>
                            ...
                            <template v-for="item in rightNavItems" :key="item.title">
                                <TooltipProvider :delay-duration="0">
                                    <Tooltip>
                                        ...
                                        <component :is="item.icon" :size="20" class="opacity-80 group-hover:opacity-100" />
                                                </a>
                                            </Button>
                                        </TooltipTrigger>
                                        <TooltipContent>
