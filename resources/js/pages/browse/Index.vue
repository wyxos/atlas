        ...
        <ContentLayout>
            ...
            <div class="mb-3 flex flex-wrap items-end gap-3">
                <div class="grid gap-1">
                    ...
                    <select class="h-9 rounded-md border px-2 text-sm dark:bg-neutral-900" v-model="form.source as any" @change="onFilterChange">
                ...
                <div class="grid gap-1">
                    ...
                    <select class="h-9 rounded-md border px-2 text-sm dark:bg-neutral-900" v-model="form.sort as any" @change="onFilterChange">
                ...
                <div class="grid gap-1">
                    ...
                    <select
                        ...
                        v-model.number="form.limit as any"
                        @change="onFilterChange"
                    >
                ...
                <Button variant="outline" :disabled="isLoading" @click="() => scroller.loadNext()" class="h-9 w-9 p-0" aria-label="Load more">
                    <ChevronsRight :size="18" />
                </Button>
                <Button variant="secondary" :disabled="isLoading" @click="resetToFirstPage" class="h-9 w-9 p-0" aria-label="First page">
                ...
                <!-- Manage Rules CTA -->
                <Button v-if="isAdmin" variant="outline" class="h-9 px-3" @click="openRulesModal">Manage Rules</Button>
