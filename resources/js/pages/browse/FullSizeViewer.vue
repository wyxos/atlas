...
import { ChevronsLeft, ChevronsRight, Eye, X, AlertTriangle } from 'lucide-vue-next'
        ...
        <div class="flex flex-1 overflow-hidden">
          ...
          <div class="flex flex-1 flex-col overflow-hidden">
            <div class="relative flex flex-1 place-items-center overflow-hidden p-2" @mouseup.capture="onDialogMouseUp">
              ...
              <div v-if="fullError" class="absolute inset-0 z-20 grid place-items-center bg-background/70 p-6 text-center">
                <div class="flex flex-col items-center gap-3">
                  <span class="text-sm font-medium text-destructive">Unable to load media</span>
                  <div class="flex gap-2">
                    <Button variant="outline" class="h-8 px-3 text-xs" @click.stop="retryFullMedia">Retry</Button>
...
<FileReactions v-if="dialogItem" :file="{ id: dialogItem.id }" :size="22"
          ...
          <Button v-if="fullError" variant="outline" :disabled="!dialogItem" @click="retryFullMedia">Retry</Button>
