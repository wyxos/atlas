...
<div v-if="(form as any).sort === 'random'" class="flex items-center gap-2">
                    ...
                    <Button variant="outline" class="h-9 w-9 p-0 cursor-pointer" @click="rerollRandom" data-test="reels-reroll" aria-label="Re-roll seed">
                        <Shuffle :size="18" />
                    </Button>
                </div>
