...
<div v-if="(form as any).sort === 'random'" class="flex items-center gap-2">
                    ...
                    <Button variant="outline" class="h-9 w-9 p-0" @click="rerollRandom" data-test="photos-reroll" aria-label="Re-roll seed">
                        <Shuffle :size="18" />
                    </Button>
                </div>

                <Button variant="outline" :disabled="isLoading" @click="() => scroller.loadNext()" class="h-9 w-9 p-0" data-test="photos-next" aria-label="Load more">
                    <ChevronsRight :size="18" />
                </Button>
                <Button variant="destructive" :disabled="isLoading" @click="resetToFirstPage" class="h-9 w-9 p-0" data-test="photos-reset" aria-label="First page">
