            ...
            App\Models\File::class => [
                'collection-schema' => [
                    'fields' => [
                        ...
                        ['name' => 'seen_preview_at', 'type' => 'int64', 'optional' => true],
                        ['name' => 'seen_file_at', 'type' => 'int64', 'optional' => true],
                        ['name' => 'is_blacklisted', 'type' => 'bool', 'optional' => true],
                        ['name' => 'blacklist_reason', 'type' => 'string', 'optional' => true],
                        ['name' => 'liked', 'type' => 'bool', 'optional' => true],
                        ['name' => 'liked_at', 'type' => 'int64', 'optional' => true],
                        ['name' => 'disliked', 'type' => 'bool', 'optional' => true],
                        ['name' => 'disliked_at', 'type' => 'int64', 'optional' => true],
                        ['name' => 'loved', 'type' => 'bool', 'optional' => true],
                        ['name' => 'loved_at', 'type' => 'int64', 'optional' => true],
                        ...
                        ['name' => 'funny', 'type' => 'bool', 'optional' => true],
                        ['name' => 'laughed_at', 'type' => 'int64', 'optional' => true],
                        ['name' => 'artist_names', 'type' => 'string', 'optional' => true],
                        ['name' => 'album_names', 'type' => 'string', 'optional' => true],
                ...
                'search-parameters' => [
                    'query_by' => 'filename,title,description,tags,path,artist_names,album_names,metadata_title,metadata_genre,metadata_comment',
                ],
            ],
