...
return [
    ...
    */
    ...
    'typesense' => [
        // Original nested client settings retained for compatibility
        'client-settings' => [
            ...
            App\Models\File::class => [
                'collection-schema' => [
                    'fields' => [
                        ...
                        ['name' => 'blacklisted', 'type' => 'bool', 'optional' => true],
                        ...
                        ['name' => 'playlist_ids', 'type' => 'int32[]', 'optional' => true, 'facet' => true],
                        ...
                        // Per-user reaction arrays for per-user feeds
                        ['name' => 'love_user_ids', 'type' => 'string[]', 'optional' => true],
                        ['name' => 'like_user_ids', 'type' => 'string[]', 'optional' => true],
