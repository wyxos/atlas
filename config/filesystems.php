...
return [
    ...
    */
    ...
    'disks' => [
        ...
        'atlas' => [
            'driver' => 'local',
            // Default root; overridden at runtime from Setting('atlas.path') in AppServiceProvider
        ...
        // App-generated assets (covers, metadata, downloads) live under <atlas.root>/.app
        'atlas_app' => [
            'driver' => 'local',
