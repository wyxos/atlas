    ...
    public function fileSchema(string $collectionName): array
    {
        return [
            ...
            'fields' => [
                ...
                ['name' => 'imported_at', 'type' => 'int64', 'optional' => true],
                ['name' => 'stored', 'type' => 'bool', 'optional' => true, 'facet' => true],
                ['name' => 'stored_at', 'type' => 'int64', 'optional' => true],
                ['name' => 'not_found', 'type' => 'bool', 'optional' => true, 'facet' => true],
                ['name' => 'auto_blacklisted', 'type' => 'bool', 'optional' => true, 'facet' => true],
