            ...
            [
                ...
                'local' => [
                    ...
                    'schema' => $localSchema->fields([
                        ...
                        $localSchema->field('downloaded_at_from', [
                            'type' => 'date',
                            'label' => 'Downloaded From',
                            'description' => 'Only include library files downloaded on or after this date.',
                            'placeholder' => 'From date',
                            'default' => '',
                        ]),
                        $localSchema->field('downloaded_at_to', [
                            'type' => 'date',
                            'label' => 'Downloaded To',
                            'description' => 'Only include library files downloaded on or before this date.',
                            'placeholder' => 'To date',
                            'default' => '',
                        ]),
                        $localSchema->field('blacklisted_at_from', [
                            'type' => 'date',
                            'label' => 'Blacklisted From',
                            'description' => 'Only include library files blacklisted on or after this date.',
                            'placeholder' => 'From date',
                            'default' => '',
                        ]),
                        $localSchema->field('blacklisted_at_to', [
                            'type' => 'date',
                            'label' => 'Blacklisted To',
                            'description' => 'Only include library files blacklisted on or before this date.',
                            'placeholder' => 'To date',
                            'default' => '',
                        ]),
