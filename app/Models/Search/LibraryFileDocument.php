...
class LibraryFileDocument extends File
{
    ...
    public function toSearchableArray(): array
    {
        ...
        return [
            ...
            'imported_at' => $this->timestampOrNull($this->imported_at),
            'stored' => $this->path !== null && ($this->downloaded || $this->imported_at !== null),
            'stored_at' => $this->timestampOrNull($this->downloaded_at) ?? $this->timestampOrNull($this->imported_at) ?? $this->timestampOrZero($this->created_at),
